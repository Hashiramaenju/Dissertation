...
.disease-info { margin-top:24px; padding:24px 28px; background:rgba(14,165,233,.08);
    border:1px solid rgba(14,165,233,.2); border-radius:16px; text-align:center; }
.disease-info p { font-size:.9rem; color:var(--text-secondary); line-height:1.8; margin:0; }
