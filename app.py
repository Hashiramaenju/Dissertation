...
.result-icon { width:100px; height:100px; margin:0 auto 24px;
    background:linear-gradient(135deg,var(--accent),#059669); border-radius:50%;
    display:flex; align-items:center; justify-content:center;
...
.selected-symptoms-display h4 { font-size:.9rem; color:var(--text-secondary); margin-bottom:12px; }
...
.disease-info { margin-top:24px; padding:20px; background:rgba(14,165,233,.1);
    border:1px solid rgba(14,165,233,.2); border-radius:16px; }
.disease-info h4 { font-size:1rem; color:var(--secondary); margin-bottom:10px;
    display:flex; align-items:center; gap:8px; }
.disease-info p { font-size:.9rem; color:var(--text-secondary); line-height:1.6; margin:0; }
...
div[data-testid="stTextInput"] input {
    background:rgba(15,23,42,.6)!important; border:1px solid var(--border)!important;
...
div[data-testid="stTextInput"] input:focus { border-color:var(--primary)!important; }
div[data-testid="stTextInput"] label { display:none!important; }

div[data-testid="stCheckbox"] > label {
    background:rgba(15,23,42,.4)!important; border:1px solid var(--border)!important;
...
div[data-testid="stCheckbox"] > label:hover {
    border-color:var(--primary)!important; background:rgba(99,102,241,.1)!important;
}
...
div[data-testid="stHorizontalBlock"] div[data-testid="stColumn"]:last-child button {
    background:rgba(148,163,184,.1)!important; color:var(--text-primary)!important;
    border:1px solid var(--border)!important; border-radius:12px!important;
    font-weight:600!important; width:100%!important; padding:14px!important;
}

.symptom-scroll { max-height:400px; overflow-y:auto; margin-bottom:16px; padding-right:4px; }
.symptom-scroll::-webkit-scrollbar { width:4px; }
.symptom-scroll::-webkit-scrollbar-track { background:rgba(15,23,42,.3); }
.symptom-scroll::-webkit-scrollbar-thumb { background:var(--primary); border-radius:4px; }
</style>
